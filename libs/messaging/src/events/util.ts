import { EventCommnandFactoryRegistry } from './decorator/event';
...
export function getCommandFactoryFromEventName(name: string) {
  return EventCommnandFactoryRegistry.get(name);
}
